 ...
 * @param {Function} scopeCallback The function to call in order to determine
 *     which local objects are in scope for this client. This function takes no
 *     parameters and should return an Array of NetObjects in scope.
 */
